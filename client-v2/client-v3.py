...
if __name__ == '__main__':
	...
	with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
		...
		if args.service == "pub":
			...
			c_sub_st = f"<iq type='set' from='{USER}@{HOST}/work' to='pubsub.{HOST}' id='{res_1}' > <pubsub xmlns='http://jabber.org/protocol/pubsub'> <subscribe node='princely_musings' jid='{USER}@{HOST}/work'/> </pubsub> </iq>"
